...
class EventsController extends AbstractController
{
    ...
    #[Route('/event', name: 'app_events_dash', methods: ['GET'])]
    public function eventdash(EventsRepository $eventsRepository): Response
    {
        return $this->render('events/eventdash.html.twig', [
            'events' => $eventsRepository->findAll(),
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_events_dash', [], Response::HTTP_SEE_OTHER);
        }
