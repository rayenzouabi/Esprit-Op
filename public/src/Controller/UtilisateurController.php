...
Filesystem $filesystem,MailerInterface $mailerInterface,
    ...
    #[Route('/Apropos', name: 'info' , methods: ['GET', 'POST'])]
    public function Apropos(Request $request): Response
    {
        return $this->render('utilisateur/About.html.twig', [
           
        ]) ; 
         
    }

    #[Route('/postuler', name: 'postuler' , methods: ['GET', 'POST'])]
    ...
    { $candidature = new Candidature();
        ...
        return $this->render('offre/candidature_form.html.twig', [
